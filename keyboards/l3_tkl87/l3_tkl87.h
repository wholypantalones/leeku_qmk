...
#define KEYMAP( \
  ...
  K0A, K0B, K0C,                K0G,                K0K, K0L, K0M,              K0N, K0O, K0P  \
) { \
  ...
  { K3A, K3B, K3C,   K3D,   K3E,   K3F, K3G,   K3H,   K3I,   K3J, K3K, K3L, K3M,   K3N, K3O, K3P, KC_NO, KC_NO, KC_NO, KC_NO}, \
  { K2A, K2B, K2C,   K2D,   K2E,   K2F, K2G,   K2H,   K2I,   K2J, K2K, K2L, K2M,   K2N, K2O, K2P, KC_NO, KC_NO, KC_NO, KC_NO}, \
  { K1A, K1B, K1C,   K1D,   K1E,   K1F, K1G,   K1H,   K1I,   K1J, K1K, K1L, K1M, KC_NO, K1O, K1P, KC_NO, KC_NO, KC_NO, KC_NO}, \
  { K0A, K0B, K0C, KC_NO, KC_NO, KC_NO, K0G, KC_NO, KC_NO, KC_NO, K0K, K0L, K0M,   K0N, K0O, K0P, KC_NO, KC_NO, KC_NO, KC_NO}  \
}
