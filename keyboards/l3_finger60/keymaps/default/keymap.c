...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = KEYMAP(
    ...
    KC_LSFT, KC_NO,   KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, TG(_LONE), KC_RSFT,
    KC_LCTL, KC_LGUI, KC_LALT, KC_NO,                  KC_SPC,         KC_NO,  KC_RALT, KC_NO,   KC_NO,   KC_RGUI,   KC_RCTL),
